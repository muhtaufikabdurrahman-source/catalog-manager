...
export default function GameCard({ game, selected, onToggleSelect, onOpen }) {
  ...
  return (
    <div
      ref={elRef}
      className={`game-card ${selected ? 'selected' : ''} ${game.jangandibeli ? 'is-jangan-dibeli' : ''}`}
      onClick={() => onOpen(game)}
    >
      <input
        type="checkbox"
      ...
      {/* Jangan Dibeli watermark */}
      {game.jangandibeli && (
        <div className="jangan-dibeli-overlay" aria-hidden="true">
          <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
            <line x1="10" y1="10" x2="90" y2="90" stroke="currentColor" strokeWidth="12" strokeLinecap="round"/>
            <line x1="90" y1="10" x2="10" y2="90" stroke="currentColor" strokeWidth="12" strokeLinecap="round"/>
          </svg>
        </div>
      )}
